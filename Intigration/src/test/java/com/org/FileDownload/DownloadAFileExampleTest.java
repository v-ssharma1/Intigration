...
public class DownloadAFileExampleTest {
	/**
	 * This example shows how to download a file with RESTAssured This will download
	 * the file as binary so can be used for images, zip files etc. The example is
	 * coded to download a source file from github, but you can download anything. I
	 * sometimes use this during GUI automating to download files. Also I use this
	 * when interacting with sites that don't provide an API.
	 */
	@Test
	public void canDownloadFilesWithRestAssured() throws IOException {

		// By default this is going to be a subfolder in your project, you can change
		// this to an
		// absolute path or resources if you want to. I kept it simple for the example
		String downloadFolder = System.getProperty("user.dir") + "/src/main/java/com/org/Resources/Downloads";
		...
		String downloadFileName = "downloadedFile_" + formater.format(calendar.getTime()) + ".txt";
	...
	private void downloadUrlAsFile(final Map<String, String> cookies, final Map<String, String> headers,
