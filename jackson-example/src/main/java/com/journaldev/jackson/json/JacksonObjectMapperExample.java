...
//refer https://www.journaldev.com/2324/jackson-json-java-parser-api-example-tutorial/amp#jackson-json-java-parser
	...
	public static void main(String[] args) throws IOException {
		...
		//convert json string to object(JSON Java data)
